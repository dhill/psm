...
public class EnrollmentStepDefinitions {
    ...
    public void i_move_to_the_individual_member_info_page() {
    ...
    public void i_move_to_the_ownership_info_page() {
    ...
    public void i_move_to_the_summary_page() {
    ...
    public void i_move_to_the_provider_statement_page() {
